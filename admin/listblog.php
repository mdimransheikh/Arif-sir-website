				...
				<div class="module">
					...
					?>
						<tr class="odd gradeX">
							...
							<td>
								<a href="editblog.php?editId=<?php echo $data['id']; ?>">Edit</a> 
								<a onclick="return confirm('Are you sure to delete?');"  href="deleteblog.php?deleteId=<?php echo $data['id']; ?>">Delete</a>
			 				</td>
						</tr>
					<?php 
						$i++;
