...
<?php include 'inc/sidebar.php'; ?>
    ...
    <?php 
        if($_SERVER['REQUEST_METHOD']=="POST"){
            ...
            $query = "INSERT INTO tbl_project(name,student,year,details,type) VALUES('$name','$student','$year','$details','$type')";
            $inserted_rows = $db->insert($query);
            if ($inserted_rows) {
             echo "<span style='font-size:18px;color:green'>New project is inserted successfully.
             </span>";
            }else {
	...
	<form class="form-horizontal row-fluid" action="" method="post" enctype="multipart/form-data">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" name="year" class="span8">
			</div>
		</div>
		<div class="control-group">
