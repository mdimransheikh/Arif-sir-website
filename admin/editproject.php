...
<?php 
    if($_SERVER['REQUEST_METHOD']=="POST"){
        ...
        if($name == '' || $student == '' || $year == '' || $details == '' || $type == ''){
            ...
            if ($updated_rows) {
             echo "<span style='font-size:18px;color:green'>Project is updated Successfully
             </span>";
            }else {
...
?> 
            ...
            <?php 
                $querySelect = "SELECT * FROM tbl_project WHERE id='$editId'";
            ...
            ?>
                <form class="form-horizontal row-fluid" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="batch" name="student" value="<?php echo $result['student']; ?>" class="span8">
                        </div>
                    </div>
                    <div class="control-group">
