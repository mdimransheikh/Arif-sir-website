...
<?php 
    if(!isset($_GET['editId']) || $_GET['editId']==NULL){
         echo "<script> location.href='listblog.php'; </script>";
        ...
        if($_SERVER['REQUEST_METHOD']=="POST"){
            ...
            if(!empty($file_name)){
                 ...
                 .implode(', ', $permited)."</span>";
                    ...
                    if ($updated_rows) {
                     echo "<span style='font-size:18px;color:green'>Blog Is Updated Successfully.
                     </span>";
                    }else {
                     echo "<span style='font-size:18px;color:red'>Blog is not Updated !!</span>";
                    }
            }
            }else{
                $query = "UPDATE tbl_post
